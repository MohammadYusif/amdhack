...
| 7 | **Fraud & compliance** | Shell-company flag (CR < 12 months) caught mid-pipeline · full SAMA audit log per scoring event · Claude-generated Arabic explanation per decision · human officer on every loan. | `13_officer_dashboard_full.png` |
